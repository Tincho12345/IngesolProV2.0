(function() {
  ...
  if (mobileNavToggleBtn) {
    ...
    // =======================================
    // CONTACT FORM → EMAILJS + MVC CREATE
    // =======================================

    document.addEventListener("DOMContentLoaded", () => {

        if (window.emailjs) {
            emailjs.init("Ox8bIMrq0l6N16cI1");
        }
        ...
        contactForm.addEventListener("submit", async (e) => {
            ...
            try {
                ...
                const response = await fetch("/SolicitudesProyecto/Create", {
                    method: "POST",
                    body: formData,
                    headers: {
                        "RequestVerificationToken":
                            contactForm.querySelector('input[name="__RequestVerificationToken"]').value
                    }
                });
                ...
                console.error("Formulario contacto error:", error);
            }
        });
    });
