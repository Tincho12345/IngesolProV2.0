        ...
        <div class="row mb-2">
            ...
            <div class="col-12 col-md-6 mb-2 mb-md-0">
                <div class="d-flex justify-content-center justify-content-md-start">
                    <form class="buscador-youtube d-flex w-100" style="max-width:420px" onsubmit="return false;">
                        <input
                            id="inputBuscador"
                            type="search"
            ...
            <div id="divFiltros"
                ...
                <div class="w-100 d-flex flex-column flex-md-row align-items-center align-items-md-end gap-2">
                    ...
                    <button
                        id="AddEntity"
                        class="btn btn-primary btn-sm text-white btn-crear-entity d-flex align-items-center justify-content-center"
